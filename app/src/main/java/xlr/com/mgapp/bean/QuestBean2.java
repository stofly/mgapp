 ...
 */
@Entity
public class QuestBean2 implements Serializable {
    ...
    @Generated(hash = 518804092)
    public QuestBean2(int id, int type, String title, String optiona,
