...
public class practise2Fragment extends BaseFragment implements RadioGroup.OnCheckedChangeListener {
    ...
    private Button optionsubmit, optionck;
...
//                rb_option_d.setEnabled(false);
    ...
    public practise2Fragment(QuestBean2 questBean) {
